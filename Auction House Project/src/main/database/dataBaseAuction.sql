ALTER TABLE Adress DROP CONSTRAINT FKAdress854198;
...
CREATE TABLE Adress (adress_id SERIAL NOT NULL, street varchar(255) NOT NULL, number int4 NOT NULL, city varchar(255) NOT NULL, country varchar(255) NOT NULL, Useruser_id int4 NOT NULL, PRIMARY KEY (adress_id));
...
ALTER TABLE Adress ADD CONSTRAINT FKAdress854198 FOREIGN KEY (Useruser_id) REFERENCES Users (user_id);
